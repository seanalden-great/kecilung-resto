  ...
  <div class="p-6 max-w-4xl mx-auto">
    <div v-if="article" class="bg-white p-6 rounded shadow">
      <div class="flex justify-between items-center border-b pb-4 mb-4">
        ...
        <span class="bg-blue-100 text-blue-800 font-semibold px-3 py-1 rounded">{{ article.code }}</span>
      </div>
      ...
      <div class="mt-8 pt-4 border-t">
        <NuxtLink to="/admin/article/article_page" class="bg-gray-600 text-white px-6 py-2 rounded shadow hover:bg-gray-700 transition">
          Kembali ke List
        </NuxtLink>
      </div>
    </div>
